<?php
/* Smarty version 3.1.30, created on 2017-05-17 09:51:19
  from "D:\phpStudy\WWW\lhao\tpl\index.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_591c1d17655e17_29302540',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '59f7a88f8dba812c999b23b44f449735c42e676a' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\lhao\\tpl\\index.html',
      1 => 1494917628,
      2 => 'file',
    ),
  ),
...
function content_591c1d17655e17_29302540 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
...
<body>
            ...
            <div class="container">
                <div class="row pad-top-bottom  move-me">
                    <div class="col-lg-5 col-md-5 col-sm-5 text-center">
                        <img src="index/img/sad.jpg" class="main-img img-circle wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".2s" alt=""/>
                        <h1 class="wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".4s">李 福豪</h1>
                        <h2 class="wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".6s">WEB前端 php</h2>
                        <a href="#about-sec" class="btn custom-btn-one btn-lg wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".8s">探索自己</a>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-2 text-center  ">
                        <a href="#about-sec" class="wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".1s">
                            ...
                            <h3 class="wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".2s">关于我</h3>
                        </a>
                        <a href="#resume-sec" class="wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".3s">
                            <i class="fa fa-briefcase icon-round"></i>
                            <h3 class="wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".4s">简历</h3>
                        </a>
                        <a href="#portfolio-sec" class="wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".5s">
                            ...
                            <h3 class="wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".6s">投资 </h3>
                        </a>
                        <a href="#hire-sec" class="wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".7s">
                            ...
                            <h3 class="wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".8s">雇佣我</h3>
                        </a>
                    </div>
                    <div class="col-lg-5 col-md-5 col-sm-5 text-center">
                        <img src="index/img/smile.jpg" class="main-img-2 img-circle wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".2s" alt="" />
                        <h1 class="wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".4s">经验</h1>
                        <h2 class="wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".6s">1+ YEARS</h2>
                        <a href="#resume-sec" class="btn custom-btn-one btn-lg wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".8s">简历下载</a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".2s">
                    ...
                    <div class="social-icon">
                        <a href="#">
                            <img src="index/img/Social/facebook.png" alt="" /></a>
                        <a href="#">
                            <img src="index/img/Social/google-plus.png" alt="" /></a>
                        <a href="#">
                            <img src="index/img/Social/twitter.png" alt="" /></a>
                    </div>
                </div>
            ...
            <div class="row  wow bounceIn animated" data-wow-duration="1s" data-wow-delay=".4s">
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12  ">
                    <div class="portfolio-sec-wrap">
                        <img class="img-responsive" src="index/img/portfolio/small/1.jpg" alt="" />
                        <div class="overlay">
                            <div class="portfolio-sec-inner">
                                <h3><a href="#">Consecte Adipis </a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur </p>
                                <a class="preview"  href="index/img/portfolio/big/1.jpg"><i class="fa fa-eye"></i>SEE PROJECT </a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12  ">
                    <div class="portfolio-sec-wrap">
                        <img class="img-responsive" src="index/img/portfolio/small/2.jpg" alt="" />
                        <div class="overlay">
                            <div class="portfolio-sec-inner">
                                <h3><a href="#">Consecte Adipis </a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur </p>
                                <a class="preview" href="index/img/portfolio/big/2.jpg"><i class="fa fa-eye"></i>SEE PROJECT </a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12  ">
                    <div class="portfolio-sec-wrap">
                        <img class="img-responsive" src="index/img/portfolio/small/3.jpg" alt="" />
                        <div class="overlay">
                            <div class="portfolio-sec-inner">
                                <h3><a href="#">Consecte Adipis </a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur </p>
                                <a class="preview" href="index/img/portfolio/big/3.jpg"><i class="fa fa-eye"></i>SEE PROJECT </a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12  ">
                    <div class="portfolio-sec-wrap">
                        <img class="img-responsive" src="index/img/portfolio/small/4.jpg" alt="" />
                        <div class="overlay">
                            <div class="portfolio-sec-inner">
                                <h3><a href="#">Consecte Adipis </a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur </p>
                                <a class="preview" href="index/img/portfolio/big/4.jpg"><i class="fa fa-eye"></i>SEE PROJECT </a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12  ">
                    <div class="portfolio-sec-wrap">
                        <img class="img-responsive" src="index/img/portfolio/small/5.jpg" alt="" />
                        <div class="overlay">
                            <div class="portfolio-sec-inner">
                                <h3><a href="#">Consecte Adipis </a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur </p>
                                <a class="preview" href="index/img/portfolio/big/5.jpg"><i class="fa fa-eye"></i>SEE PROJECT </a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12  ">
                    <div class="portfolio-sec-wrap">
                        <img class="img-responsive" src="index/img/portfolio/small/6.jpg" alt="" />
                        <div class="overlay">
                            <div class="portfolio-sec-inner">
                                <h3><a href="#">Consecte Adipis </a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur </p>
                                <a class="preview" href="index/img/portfolio/big/6.jpg"><i class="fa fa-eye"></i>SEE PROJECT </a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12  ">
                    <div class="portfolio-sec-wrap">
                        <img class="img-responsive" src="index/img/portfolio/small/7.jpg" alt="" />
                        <div class="overlay">
                            <div class="portfolio-sec-inner">
                                <h3><a href="#">Consecte Adipis </a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur </p>
                                <a class="preview" href="index/img/portfolio/big/7.jpg"><i class="fa fa-eye"></i>SEE PROJECT </a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12  ">
                    <div class="portfolio-sec-wrap">
                        <img class="img-responsive" src="index/img/portfolio/small/8.jpg" alt="" />
                        <div class="overlay">
                            <div class="portfolio-sec-inner">
                                <h3><a href="#">Consecte Adipis </a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur </p>
                                <a class="preview" href="index/img/portfolio/big/8.jpg"><i class="fa fa-eye"></i>SEE PROJECT </a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!--  JQUERY CORE SCRIPTS -->
    <?php echo '<script'; ?>
 src="index/js/jquery-1.10.2.js"><?php echo '</script'; ?>
>
    <!--  BOOTSTRAP SCRIPTS -->
    <?php echo '<script'; ?>
 src="index/js/bootstrap.js"><?php echo '</script'; ?>
>
    <!--  SCROLL SCRIPTS -->
    <?php echo '<script'; ?>
 src="index/js/jquery.easing.min.js"><?php echo '</script'; ?>
>
    <!--  WOW ANIMATION SCRIPTS -->
    <?php echo '<script'; ?>
 src="index/js/wow.min.js"><?php echo '</script'; ?>
>
    <!-- EASY PIE CHART SCRIPTS -->
    <?php echo '<script'; ?>
 src="index/js/jquery.easypiechart.min.js"><?php echo '</script'; ?>
>
    <!-- PRETTY PHOTO SCRIPTS -->
    <?php echo '<script'; ?>
 src="index/js/jquery.prettyPhoto.js"><?php echo '</script'; ?>
>
    <!--  STYLE SWITCHER SCRIPTS -->
    <?php echo '<script'; ?>
 src="index/js/styleSwitcher.js"><?php echo '</script'; ?>
>
    <!--  CUSTOM SCRIPTS -->
    <?php echo '<script'; ?>
 src="index/js/custom.js"><?php echo '</script'; ?>
>
